...
export class NftItemCreated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save NftItemCreated entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type NftItemCreated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("NftItemCreated", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): NftItemCreated | null {
    return changetype<NftItemCreated | null>(
      store.get("NftItemCreated", id.toHexString())
    );
  }
...
export class RoyaltyAmountSent extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save RoyaltyAmountSent entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type RoyaltyAmountSent must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("RoyaltyAmountSent", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): RoyaltyAmountSent | null {
    return changetype<RoyaltyAmountSent | null>(
      store.get("RoyaltyAmountSent", id.toHexString())
    );
  }
